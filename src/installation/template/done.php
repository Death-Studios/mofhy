		...
		<div class="row align-items-center mt-3">
			...
			<div class="col">
				<div class="btn-list justify-content-end">
					<a href=".././admin" name="submit" class="btn btn-primary">
						Admin Login
					</a>
				</form>
				</div>
