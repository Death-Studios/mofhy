...
if(isset($_POST['signup'])){
	...
	// Begin Temp Mail Check ...
	if(strpos($FormData['email'], 'mxclip.com'))
	{
        $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'protonmail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'mannawo.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'vusra.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'prtnx.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], '20minutemail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'lazyinbox.xyz')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], '10minut.xyz')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'temp-mail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'temp-mail.de')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'temp-mail.org')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'testore.co')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'tmailinator.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'tormail.org')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'ugimail.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'kvhrr.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'sharklasers.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'guerrillamail.info')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'grr.la')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'guerrillamail.biz')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'guerrillamail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'guerrillamail.de')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'guerrillamail.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'guerrillamail.org')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'guerrillamailblock.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'pokemail.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'spam4.me')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'emailnax.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'wemel.top')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'xbpantibody.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}	
	elseif(strpos($FormData['email'], 'yopmail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'mail.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'inbox.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'list.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'bk.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'internet.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'tempr.email')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'discard.email')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'discardmail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'discardmail.de')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'spambog.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'spambog.de')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'spambog.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'knol-power.nl')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], '0815.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'freundin.ru')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'smashmail.de')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 's0ny.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'pecinan.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'budaya-tionghoa.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'lajoska.pe.hu')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], '1mail.x24hr.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'from.onmypc.info')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'now.mefound.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'mowgli.jungleheart.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'pecinan.org')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'budayationghoa.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'CR.cloudns.asia')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'TLS.cloudns.asia')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'maildrop.cc')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'mailsac.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'nthrl.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'midiharmonica.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'norwegischlernen.info')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'onekisspresave.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'thecarinformation.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'acrossgracealley.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'vintomaper.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'labworld.org')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'kobrandly.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'crossmailjet.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'mac-24.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'bestparadize.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'thejoker5.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'coffeetimer24.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'blondemorkin.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'best-john-boats.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'cloud-mail.top')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'cashflow35.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'greencafe24.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'foreastate.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'hottempmail.cc')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'bloggybro.cc')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'edudigy.cc')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'greendike.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'playfuny.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'specialkien.website')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'getmail.lt')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'gmailines.site')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	...
	elseif(strpos($FormData['email'], 'temporary-mail.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'bytetutorials.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'companycontacts.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'iffygame.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'maileven.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'smuggroup.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'besttempmail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'chapedia.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'worldzipcodes.net')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'chapedia.org')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'vistaemail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'techdf.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'dyyar.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'omeea.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'uspmail.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'qq.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'gamil.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> Wait! Are your sure that the email domain is <code>gamil.com</code>? It sounds like an incorrect representation of <code>gmail.com</code>.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'alotivi.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'nvhrw.com')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
	elseif(strpos($FormData['email'], 'obgsdf.site')){
	    $_SESSION['message'] = '<div class="alert alert-danger" role="alert"> You cannot sign up with a disposable email address. A valid email address is required to receive important status updates regarding your account.</div>';
		header('location: ../login');
		exit;
	}
